...
Base Image = Foundation + Runtime Environment for container. **“Foundation”** means the basic platform and components required before your application can run inside the container.
...
Base image provides runtime environment and filesystem, while Host OS provides the kernel required to run containers.
